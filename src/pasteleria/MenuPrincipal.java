...
public class MenuPrincipal extends javax.swing.JFrame {
    ...
    private boolean accesoCaja = false;
    private boolean accesoPedido = false;
    private boolean accesoTotal = false;

    /**
     * Creates new form MenuPrincipal
     */
    public MenuPrincipal(String usuario, int accesoCaja, int accesoTotal, int accesoPedido) {
        initComponents();
        ...
        codUsuario.setText(usuario);
        java.awt.Color a = new java.awt.Color(242, 189, 219);
        this.getContentPane().setBackground(a);
        verificarEntradasPermiso(accesoCaja, accesoTotal, accesoPedido);
    }
    ...
    private void verificarEntradasPermiso(int accesoCaja, int accesoTotal, int accesoPedido) {
        if (accesoTotal == 1) {
            this.accesoTotal = true;
        } else if (accesoCaja == 1) {
            this.accesoCaja = true;
        } else if (accesoPedido == 1) {
            this.accesoPedido = true;
        }
    }

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ocultarBotones();
        if (this.accesoTotal == true || this.accesoPedido == true) {
            Pedido p = new Pedido();
            p.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "No posee permiso", "Aviso", JOptionPane.ERROR_MESSAGE);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ocultarBotones();
        if (this.accesoTotal == true || this.accesoCaja == true) {
            Venta v = new Venta();
            v.setVisible(true);
        } else {
            JOptionPane.showMessageDialog(this, "No posee permiso", "Aviso", JOptionPane.ERROR_MESSAGE);
...
//    }
    ...
    private javax.swing.JLabel codUsuario;
